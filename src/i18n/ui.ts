...
export const ui = {
  en: {
    ...
    'meta.description':
      'Automated luggage storage open 7am to 10pm in central Paris. Drop your bags in a secure smart locker. From €3/hour. No queue, no humans, no stress.',
    ...
    'faq.a5': 'Your locker stays sealed until you come back. If you go over your booked time, the extra hours are billed automatically at the hourly rate. You can also extend in advance from your phone.',
  ...
  fr: {
    ...
    'meta.description':
      "Consigne à bagages automatisée ouverte de 7h à 22h au cœur de Paris. Déposez vos valises dans un casier connecté sécurisé. Dès 3 €. Sans queue, sans humain, sans stress.",
    ...
    'faq.a5': "Votre casier reste fermé jusqu'à votre retour. Si vous dépassez l'heure prévue, le temps supplémentaire est facturé automatiquement au tarif horaire. Vous pouvez aussi prolonger à l'avance depuis votre téléphone.",
