...
export const ui = {
  en: {
    ...
    'meta.description':
      '24/7 automated luggage storage in central Paris. Drop your bags in a secure smart locker. From €3/hour. No queue, no humans, no stress.',
    ...
    // Hero
    'hero.eyebrow': 'Paris · Sentier · 24/7',
    'hero.title.a': 'We',
    'hero.title.b': 'store,',
    'hero.title.c': 'you',
    ...
    'hero.stat.uptime': '24/7',
    'hero.stat.uptime.label': 'Always open',
    'hero.stat.from': 'From €3',
    'hero.stat.from.label': '3-hour minimum',
    ...
    'reasons.r1.title': '24/7 access',
    'reasons.r1.desc': 'Drop or pick up your luggage anytime, day or night.',
    ...
    'reasons.r5.desc': 'From €3 — pay only what you use, hourly or daily.',
    ...
    'reasons.r8.desc': 'Hourly or daily — your call, your trip.',
    ...
    'faq.a1': "Find a Consign locker on the map, book it in a few seconds, drop your luggage and lock it from your phone. Come back to pick it up whenever — we're open 24/7.",
    ...
    'faq.a3': 'Our lockers fit standard cabin and check-in suitcases. The biggest format takes a 75 cm tall suitcase plus a small bag on top. Backpacks, strollers, ski gear — most travel kit fits.',
    'faq.q4': 'How long can I leave my luggage?',
    'faq.a4': 'From 3 hours to several days. You set the duration when booking and you can extend it remotely from your phone if your plans change.',
    'faq.q5': "What if I'm late picking up?",
    'faq.a5': 'No drama — your locker stays sealed until you come back. If you pass the booked time, the extra hours are billed automatically at the hourly rate. You can also extend in advance from your phone.',
    'faq.q6': 'Can I book in advance?',
    'faq.a6': "Yes — book in 30 seconds from your phone, no account needed. Pay only when you confirm. Show up, scan your booking, drop your luggage.",
    'faq.q7': 'What payment methods do you accept?',
    'faq.a7': 'Cards (Visa, Mastercard, Amex), Apple Pay and Google Pay. Everything is processed securely online — no cash needed.',
    ...
    'loc.address.value': '57 rue de Cléry · 75002 Paris',
    'loc.hours.label': 'Hours',
    'loc.hours.value': 'Open 24 / 7',
    ...
    'how.step2.desc': 'Reserve a locker in seconds — pick the duration, pay online.',
    'how.step3.title': 'Drop',
    'how.step3.desc': 'Place your luggage in your secure locker and lock it from your phone.',
    'how.step4.title': 'Explore',
    'how.step4.desc': "Go enjoy Paris with your hands free. Come back whenever — we're open 24/7.",
    ...
    'contact.method.email.value': 'hello@consign.paris',
    'contact.method.email.hint': 'Reply within 24 h',
    'contact.method.whatsapp.label': 'WhatsApp',
    'contact.method.whatsapp.value': '+33 6 00 00 00 00',
    'contact.method.whatsapp.hint': 'For urgent stuff',
    'contact.method.visit.label': 'Visit',
    'contact.method.visit.value': '57 rue de Cléry, 75002 Paris',
    'contact.method.visit.hint': 'Open 24 / 7',
    ...
    'business.case2.desc': 'No reception desk? No problem. Guests drop bags 24/7.',
    ...
    'business.step2.desc':
      "Locker delivered and connected — branded with your logo.",
    ...
    'business.contact.subtitle':
      "Tell us a few details about your spot and we'll get back fast — usually within a day.",
  ...
  fr: {
    ...
    'meta.description':
      "Consigne à bagages automatisée 24h/24 au cœur de Paris. Déposez vos valises dans un casier connecté sécurisé. Dès 3 € de l'heure. Sans queue, sans humain, sans stress.",
    ...
    'hero.stat.uptime': '24/7',
    'hero.stat.uptime.label': 'Toujours ouvert',
    'hero.stat.from': 'Dès 3 €',
    'hero.stat.from.label': 'Minimum 3 heures',
    ...
    'reasons.r1.title': 'Accès 24h/24',
    'reasons.r1.desc': 'Déposez ou récupérez à toute heure, jour et nuit.',
    ...
    'reasons.r5.desc': "Dès 3 € — vous payez ce que vous utilisez, à l'heure ou à la journée.",
    ...
    'reasons.r8.desc': "À l'heure ou à la journée — à vous de choisir.",
    ...
    'faq.a1': "Trouvez un casier Consign sur la carte, réservez-le en quelques secondes, déposez vos bagages et verrouillez-le depuis votre téléphone. Revenez les chercher quand vous voulez — on est ouvert 24h/24.",
    ...
    'faq.a3': "Nos casiers accueillent les valises cabine et soute standard. Le plus grand format prend une valise de 75 cm + un petit sac. Sacs à dos, poussettes, skis — la plupart des bagages passent.",
    'faq.q4': 'Combien de temps puis-je laisser mes bagages ?',
    'faq.a4': "De 3 heures à plusieurs jours. Vous choisissez la durée à la réservation et vous pouvez la prolonger à distance depuis votre téléphone si vos plans changent.",
    'faq.q5': 'Que se passe-t-il si je suis en retard ?',
    'faq.a5': "Pas de drame — votre casier reste fermé jusqu'à votre retour. Si vous dépassez l'heure prévue, le temps supplémentaire est facturé automatiquement au tarif horaire. Vous pouvez aussi prolonger à l'avance depuis votre téléphone.",
    'faq.q6': 'Puis-je réserver à l\'avance ?',
    'faq.a6': "Oui — réservation en 30 secondes depuis votre téléphone, sans compte. Vous ne payez qu'à la confirmation. Arrivez, scannez votre réservation, déposez vos bagages.",
    'faq.q7': 'Quels moyens de paiement acceptez-vous ?',
    'faq.a7': "Cartes (Visa, Mastercard, Amex), Apple Pay et Google Pay. Tout se fait en ligne en sécurité — pas besoin d'espèces.",
    ...
    'how.step2.desc': 'Réservez un casier en quelques secondes — choisissez la durée, payez en ligne.',
    'how.step3.title': 'Déposer',
    'how.step3.desc': 'Déposez vos bagages dans votre casier sécurisé et verrouillez-le depuis votre téléphone.',
    'how.step4.title': 'Profiter',
    'how.step4.desc': "Partez profiter de Paris les mains libres. Revenez quand vous voulez — on est ouvert 24h/24.",
    ...
    'contact.subtitle':
      "Questions, objets oubliés, idées de partenariat — on lit tout et on répond sous 24 h.",
    'contact.method.email.label': 'Email',
    'contact.method.email.value': 'hello@consign.paris',
    ...
    'contact.method.visit.value': '57 rue de Cléry, 75002 Paris',
    'contact.method.visit.hint': 'Ouvert 24h / 24',
    ...
    'business.case2.desc': "Pas de réception ? Pas de souci. Les clients déposent 24h/24.",
    ...
    'business.step2.desc':
      "Casier livré et connecté — brandé avec votre logo.",
    ...
    'business.contact.subtitle':
      "Donnez-nous quelques infos sur votre emplacement et on revient vite vers vous — généralement sous 24 h.",
